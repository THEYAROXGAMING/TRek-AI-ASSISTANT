...
 var h = d.getHours(); 
 ...
 var hello=["HELLO","HI", "HELLO TREK","HEY THERE","HEY","HI DUDE","HI TREK"];
 var gm=["GM","GOOD MORNING","GOOD MORNING TREK", "GOOD MORNING BRO"];
 var bad=["BAD","NOT BAD","USELESS","NOT WORKING","NOT GOOD"];
 var ge=["GOOD EVNG","GOOD EVENING","GOOD EVENING TREK","GOOD EVENING NIKKY"];
 ...
 var gaf=["GOOD AFTERNOON","GOOD AFTERNOON NIKKY","GOOD Afternoon ⁿ" ];
...
isInArray(wru, lastmsg)==true?(smsg="I am soul of the code", k=smsg):
...
(smsg="Sorry, I have no answer for that. If you say so I can search for you. To search, <br> type <q><b> Search Your keyword </b></q> for example type : <b>Search Google</b>",k="Sorry, I have no answer for that. this code is in devlopmental stage . some results may vary");
